...
Шляхом клонування репозиторію git [github.com/remy/nodemon](https://github.com/remy/nodemon) або за допомогою команди npm:
...
* «проміжне ПЗ» для додаткової обробки запиту у будь-який момент у конвеєрі обробки запитів.

У той час як сам express досить мінімалістичний, розробники створили сумісні пакети проміжного програмного забезпечення для вирішення практично будь-якої проблеми з веб-розробкою. Існують бібліотеки для роботи з файлами cookie, сеансами, входами користувачів, параметрами URL, даними POST, заголовками безпеки та багатьма іншими. Ви можете знайти список пакетів проміжного програмного забезпечення, підтримуваних командою Express у [Express Middleware](http://expressjs.com/en/resources/middleware.html) (поряд зі списком деяких популярних пакетів сторонніх виробників).

**Встановлення express**

Перед встановленням завантажте та встановіть Node.js. Якщо це абсолютно новий проект, переконайтеся, що спочатку створено файл package.json за допомогою команди npm init.

        npm install express --save
        
Репозиторій git: [github.com/expressjs/express](https://github.com/expressjs/express)
 
## Існуючі веб-сервіси розкладу занять
 
Багато університетів містить інформацію про розклад занять на головному сайті. Деякі університети мають окремий веб-сервіс для розкладу, що є зручнішим на мою думку. Ось деякі такі сервіси.
 
#### [rozklad.kpi](http://rozklad.kpi.ua/)
 
Веб-сервіс Київського політехнічного інституту ім. Ігоря Сікорського, який містить інформацію про розклад занять для студентів і викладачів, а також розклад сесії.
 
#### [mkr.udau.edu](http://mkr.udau.edu.ua/)
 
Веб-сервіс Уманського національного університета садівництва, який надає можливість переглянути розклад занять для окремого студента, навчальної групи, викладача, успішність і навчальний план студента та інше.

#### [rozklad.znau.edu](http://rozklad.znau.edu.ua/cgi-bin/timetable.cgi?n=700)

Веб-сервіс Поліського національного університету, який дає можливісь переглянути розклад занять для студентів.

#### [schedule.puet.edu](https://schedule.puet.edu.ua/)

Веб-сервіс Полтавського університету економіки і торгівля, який дає можливісь переглянути розклад занять для студентів.

### Порівняльна характеристика існуючих засобів вирішення завдання

| Назва             | Актуальність даних | Вартість користування | Доступні мови користування        | Зручність інтерфейсу |
|:-----------------:|:------------------:|:---------------------:|:---------------------------------:|:--------------------:|
| rozklad.kpi       |          +         | Безкоштовно           | Українська                        |           +          |
| mkr.udau.edu      |          +         | Безкоштовно           | Українська, англійська, російська |           +          |
| rozklad.znau.edu  |          +         | Безкоштовно           | Українська                        |           +          | 
| schedule.puet.edu |          +         | Безкоштовно           | Українська, англійська            |           +          |
